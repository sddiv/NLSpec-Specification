...
| **2** | N specs | `nlspec_split`, namespaces, cross-spec queries | Multiple projects/teams |
...
├── NLSPEC-TEMPLATE.md           # The 15-section spec template
...
| `specs/mcp-server-spec.md` | Extensions — decomposition, namespaces, 8 more tools | 2+ |
...
specification. The 15 sections guide you through everything from abstract to deployment.
...
| **Spec format** | Implicit (RECORD, FUNCTION, etc.) | Freeform markdown | Freeform markdown | Formalized 15-section template with typed elements |
